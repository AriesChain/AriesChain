...
// Syncing provides information when this nodes starts synchronising with the Quickchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  quickchain.SyncProgress `json:"status"`
}
