// Contains all the wrappers from the quickchain root package.
...
// the quickchain network.
type SyncProgress struct {
	progress quickchain.SyncProgress
}
