...
type Database struct {
	diskdb qctdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb qctdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch qctdb.Batch) error {
	// If the node does not exist, it's a previously committed node
