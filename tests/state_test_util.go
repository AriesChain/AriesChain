...
// See https://github.com/quickchain/EIPs/issues/176 for the test format specification.
...
func MakePreState(db qctdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/quickchain/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
