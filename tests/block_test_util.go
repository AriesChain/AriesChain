...
// 	chain, err := core.NewBlockChain(db, nil, config, qcthash.NewShared(), vm.Config{})
// 	//chain, err := core.NewBlockChain(db, nil, config, poa.New(), vm.Config{})
// 	if err != nil {
// 		return err
// 	}
// 	defer chain.Stop()
...
/* See https://github.com/quickchain/tests/wiki/Blockchain-Tests-II
