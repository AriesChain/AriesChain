...
func newTestLDB() (*qctdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "qctdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := qctdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db qctdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db qctdb.Database, t *testing.T) {
	const n = 8
