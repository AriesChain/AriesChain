...
import (
	...
	"github.com/quickchainproject/quickchain/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*qctapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx qctapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*qctapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := qctapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
