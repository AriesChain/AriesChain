...
var (
	...
	// BFTChainConfig contains the chain parameters to run a node on the BFT test network.
	BFTChainConfig = &ChainConfig{
		ChainId:        big.NewInt(8055),
		HomesteadBlock: big.NewInt(1),
		DAOForkBlock:   nil,
		DAOForkSupport: true,
		EIP150Block:    big.NewInt(2),
	...
	DBFTChainConfig = &ChainConfig{
		...
		DBFT: &DBFTConfig{
			...
			Validators: []common.Address{
				common.HexToAddress("0x5311494Fd08DAbB2b3De991250ff628260CAd7F7"),
			},
		},
	}
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/quickchain/EIPs/issues/150)
