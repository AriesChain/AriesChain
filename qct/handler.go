...
import (
	...
	"github.com/quickchainproject/quickchain/qct/fetcher"
...
func NewProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkId uint64, mux *event.TypeMux, txpool txPool, engine consensus.Engine, blockchain *core.BlockChain, chaindb qctdb.Database) (*ProtocolManager, error) {
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping Quickchain protocol")
	...
	log.Info("Quickchain protocol stopped")
}
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	p.Log().Debug("Quickchain peer connected", "name", p.Name())
