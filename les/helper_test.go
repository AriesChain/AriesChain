...
import (
	...
	"github.com/quickchainproject/quickchain/les/flowcontrol"
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db qctdb.Database) (*ProtocolManager, error) {
	var (
	...
	if lightSync {
		...
		bloomIndexer := let.NewBloomIndexer(db, params.BloomBitsBlocks)
		bloomIndexer.AddChildIndexer(bbtIndexer)
		bloomIndexer.Start(blockchain)

		gchain, _ := core.GenerateChain(gspec.Config, genesis, qcthash.NewFaker(), db, blocks, generator)
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db qctdb.Database) *ProtocolManager {
