...
type BloomIndexer struct {
	...
	db  qctdb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db qctdb.Database, size uint64) *core.ChainIndexer {
	backend := &BloomIndexer{
		db:   db,
		size: size,
	}
	table := qctdb.NewTable(db, string(core.BloomBitsIndexPrefix))
