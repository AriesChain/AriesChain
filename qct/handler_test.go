...
func testGetNodeData(t *testing.T, protocol int) {
	...
	statedb, _ := qctdb.NewMemDatabase()
...
func testDAOChallenge(t *testing.T, localForked, remoteForked bool, timeout bool) {
	...
	if !timeout {
		blocks, _ := core.GenerateChain(&params.ChainConfig{}, genesis, qcthash.NewFaker(), db, 1, func(i int, block *core.BlockGen) {
			if remoteForked {
