...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	ethConf := &eth.Config{
		...
		Ethash: qcthash.Config{
			PowMode: qcthash.ModeTest,
		},
	}
	if confOverride != nil {
		confOverride(ethConf)
	}
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return let.New(ctx, ethConf) }); err != nil {
	...
	var quickchain *eth.Ethereum
	stack.Service(&quickchain)
